...
var menuToggleBtn = header ? header.querySelector('[data-nav-toggle]') : null;
var mainNav = header ? header.querySelector('.main-nav') : null;
var mainMenuLinks = mainNav ? Array.from(mainNav.querySelectorAll('.main-nav__item > a, .main-nav__item > button')) : null;
var mainOtherLinks = mainNav ? Array.from(mainNav.querySelectorAll('.main-nav__wrapper > a')) : null;
...
var openMenu = function openMenu() {
  if (!header.classList.contains('is-opened')) {
    ...
    mainOtherLinks.forEach(function (item) {
      return item.removeAttribute('tabindex');
    });
